...
{
  CHECK_EQUAL (0, runner.RunTests (list, NULL, 0));
...
TEST_FIXTURE (TestRunnerFixture, CallsReportFailureOncePerFailingTest)
{
  ...
  CHECK_EQUAL (2, runner.RunTests (list, NULL, 0));
...
{
  runner.RunTests (list, "OtherSuite", 0);
